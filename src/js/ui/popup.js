    ...
    case ActionType.action:
      switch (message.action) {
        ...
        case ActionType.oauth.simkl.redirect:
          // TODO setting the simklPinCode in local storage in service worker
          // Think if this is needed here as after redirect this sendMessage is not firing due to some change in how chrome handles it. (compared to 2022 version)
          break;
